...
public class Input {
	...
	public static final int NUKEYCODES = 256;
	public static final int NUMOUSEBUTTONS = 5;
	...
	private static boolean[] lastKeys = new boolean[NUKEYCODES];
	private static boolean[] lastMouse = new boolean[NUMOUSEBUTTONS];
	...
	public static void update(){
		for(int i = 0; i < NUKEYCODES; i++)
			lastKeys[i] = getKey(i);
		
		for(int i = 0; i < NUMOUSEBUTTONS; i++)
