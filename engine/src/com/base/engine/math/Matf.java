...
public class Matf {
	...
	public static Matf initPerspective(float fov, float aspectRatio, float zNear, float zFar){
		return new Matf(Mathf.perspectiveMatrix3d(fov, aspectRatio, zNear, zFar));
	}
	public static Matf initIdentity3(){
		return new Matf(Mathf.identityMatrix3d());
	}
	public static Matf initTranslation3(float x, float y, float z){
		return new Matf(Mathf.translationMatrix3d(x, y, z));
	}
	public static Matf initScaling3(float x, float y, float z){
		return new Matf(Mathf.scalingMatrix3d(x, y, z));
	}
