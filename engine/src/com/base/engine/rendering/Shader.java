...
public class Shader {
	...
	public void updateUniforms(Transform transform, Material material, RenderingEngine renderingEngine){
		Matf worldMatrix = transform.getTransformation();
		Matf MVPMatrix = renderingEngine.getMainCamera().getViewProjection().multiply(worldMatrix);
	...
	private void addAllUniforms(String shaderText){
		...
		while(uniformStartLocation != -1)
		{
			if(!(uniformStartLocation != 0
					...
					&& Character.isWhitespace(shaderText.charAt(uniformStartLocation + UNIFORKEYWORD.length())))) {
	...
	public void setUniform(String uniformName, Matf value){
