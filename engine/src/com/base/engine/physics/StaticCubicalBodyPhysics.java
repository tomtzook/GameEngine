...
public class StaticCubicalBodyPhysics extends StaticPhysicsObject{
	
	public StaticCubicalBodyPhysics(Dimensions.Cuboid dimensions) {
		super(dimensions);
	}
	public StaticCubicalBodyPhysics(float length, float width, float height, float mass) {
